...
<div id='add-popover' class='modal fade' role='dialog' tabindex='-1'>
	...
	<div class='col-md-8'>
		<form action="<?php echo base_url(); ?>docpro_setup/company/add" method='post' class='body'>
			<div class='modal-body'>
				<table width='90%'>
					<tr>
						<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Name</label></td>
						<td colspan='3' style='padding-top: 10px;'><input class='form-control' type='text' name='add-name' placeholder="For Non-individual"></td>
					</tr>
					<tr>
						<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Owner Name</label></td>
...
<div id='edit-popover' class='modal fade' role='dialog' tabindex='-1'>
	...
	<div class='col-md-8'>
		<form action="<?php echo base_url(); ?>docpro_setup/company/edit" method='post' class='body'>
			<div class='modal-body'>
...
<div id='update-popover' class='modal fade' role='dialog' tabindex='-1'>
	...
	<div class='col-md-8'>
		<form action="<?php echo base_url(); ?>docpro_setup/company/update" method='post' class='body'>
			<div class='modal-body'>
