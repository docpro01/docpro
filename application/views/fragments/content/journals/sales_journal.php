							...
							<div role="tabpanel">
								...
								<div class="tab-content">
									...
									<div role="tabpanel" class="tab-pane" id="business-partners">
										<div class='card'>
											<div class='card-body' style='padding-top: 10px;'>
												<table id='sales-bp-table' class='table table-hover table-bordered table-striped table-responsive' cellspacing="0" style="min-width: 1200px">
													<thead>
														<th>BP Class</th>
														<th>BP Code</th>
														<th>BP Name</th>
										...
										<div id='bp-transaction-details' class='card box box-primary collapsed-box' style='margin: 0;'>
											...
											<div class='card-body box-body' style="padding-top: 10px;">
												<table id='sales-transaction-details-table' class='table table-bordered table-hovered table-striped' style='min-width: 1400px;'>
													<thead>
														<th>Trans ID</th>
														<th>Trans Date</th>
														<th>Journal</th>
												...
												<div class='card-body' id='card-2-form' style='padding: 0; padding-top: 15px; display: none;'>
													...
													<div class='col-md-12 transaction-input-row-gutter' style='margin-top: 5px;'>
														...
														<div class='col-md-3 col-input-custom form-group label-floating has-primary trans-select'>
															...
															<ui-select id='bp_name' ng-model="selected_bp.bp" theme="selectize" class="form-control" ng-required='true'>
