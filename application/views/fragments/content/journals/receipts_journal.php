							...
							<div role="tabpanel">
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane active" id="summary">
										<div class='card'>
											<div class='card-body' style='padding-top: 10px;'>
												<table id='receipts-journal-summary-table' class='table table-hover table-bordered' cellspacing="0" style='min-width: 1400px;'>
													<thead>
														<th>Trans ID</th>
														<th>Trans Date</th>
														<th>Journal</th>
																...
																<div class='row' style='padding-left: 1%; padding-right: 1%;'>
																	<table width='100%'>
																		...
																		<tr>
																			...
																			<td>&nbsp;</td>
																			<td style='padding-right: 5px;'><input name='vat_receipts' class='form-control' type='text' style='border: none; background-color: #FFF' readonly /></td>
																		...
																		<tr>
																			...
																			<td>&nbsp;</td>
																			<td style='padding-right: 5px;'><input name='zero_rated_receipts' class='form-control' type='text' style='border: none; background-color: #FFF' readonly /></td>
																			<td style='padding-left: 10px; background-color: #BBBBBB; color: #000;'><label>Zero rated receipts</label></td>
																		</tr>
																		<tr>
																			...
																			<td>&nbsp;</td>
																			<td style='padding-right: 5px;'><input name='exempt_receipts' class='form-control' type='text' style='border: none; background-color: #FFF' readonly /></td>
																		...
																		<tr>
																			...
																			<td>&nbsp;</td>
																			<td style='padding-right: 5px;'><input name='non_vat_receipts' class='form-control' type='text' style='border: none; background-color: #FFF' readonly /></td>
									...
									<div role="tabpanel" class="tab-pane" id="business-partners">
										<div class='card'>
											<div class='card-body' style='padding-top: 10px;'>
												<table id='receipts-bp-table' class='table table-hover table-bordered table-striped table-responsive' cellspacing="0" style="min-width: 1200px">
													<thead>
														<th>BP Class</th>
														<th>BP Code</th>
														<th>BP Name</th>
										...
										<div id='bp-transaction-details' class='card box box-primary collapsed-box' style='margin: 0;'>
											...
											<div class='card-body box-body' style="padding-top: 10px;">
												<table id='receipts-transaction-details-table' class='table table-bordered table-hovered table-striped' style='min-width: 1400px;'>
													<thead>
														<th>Trans ID</th>
														<th>Trans Date</th>
														<th>Journal</th>
									...
									<div role="tabpanel" class="tab-pane" id="new-transactions">
										<form action="<?php echo base_url(); ?>journals/save_receipt_trans" method='post'>
											<div class='card'>
