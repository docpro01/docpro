							...
							<div role="tabpanel">
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane active" id="summary">
										<div class='card'>
											<div class='card-body' style='padding-top: 10px;'>
												<table id='adjustments-journal-summary-table' class='table table-hover table-bordered' cellspacing="0" style='min-width: 1400px;'>
													<thead>
														<th>Trans ID</th>
														<th>Trans Date</th>
														<th>Journal</th>
									...
									<div role="tabpanel" class="tab-pane" id="business-partners">
										<div class='card'>
											<div class='card-body' style='padding-top: 10px;'>
												<table id='adjustments-bp-table' class='table table-hover table-bordered table-striped table-responsive' cellspacing="0" style="min-width: 1200px">
													<thead>
														<th>BP Class</th>
														<th>BP Code</th>
														<th>BP Name</th>
										...
										<div id='bp-transaction-details' class='card box box-primary collapsed-box' style='margin: 0;'>
											...
											<div class='card-body box-body' style="padding-top: 10px;">
												<table id='adjustments-transaction-details-table' class='table table-bordered table-hovered table-striped' style='min-width: 1400px;'>
													<thead>
														<th>Trans ID</th>
														<th>Trans Date</th>
														<th>Journal</th>
									...
									<div role="tabpanel" class="tab-pane" id="new-transactions">
										<form action="<?php echo base_url(); ?>journals/save_adjustment_trans" method='post'>
											<div class='card'>
											...
											<div id='transaction-document' class='card' style='margin: 0; padding: 0;'>
												<div class='card-header'>
															...
															<table class='table table-hover table-bordered no-margin'>
																...
																<tbody id='other-details-table'>
																	<tr>
																		...
																		<td>
																			<div class='form-group no-margin'>
																				<input ng-model='verified_by' name='verified_by' class='form-control' type='text' style='text-align: center;' >
																			</div>
																		</td>
																		<td>
																			<div class='form-group no-margin'>
																				<input ng-model='approved_by' name='approved_by' class='form-control' type='text' style='text-align: center;' >
																			</div>
																		</td>
																		<td>
																			<div class='form-group no-margin'>
																				<input ng-model='received_by' name='received_by' class='form-control' type='text' style='text-align: center;' >
																			</div>
																		</td>
																	</tr>
																</tbody>
