...
<script>
	var summary_table = $('#disbursements-journal-summary-table').DataTable({
							ajax: window.location.origin+'/journals/disbursements/journals_summary/get',
							columns: [
										{'data': 'co_trans_id'},
										{
	...
	var bp_summary_table = $('#disbursements-bp-table').DataTable({
								ajax: window.location.origin+'/journals/disbursements/bp/get',
								columns: [
											{'data': 'co_bp_class'},
											{'data': 'co_bp_code'},
											{'data': 'bp_name'},
	...
	var bp_transaction_details_table = $('#disbursements-transaction-details-table').DataTable({
							ajax: window.location.origin+'/journals/disbursements/bp_transaction/get?bp_id=0',
							columns: [
										{'data': 'co_trans_id'},
										{
											mData: function(rowData, settings, fullData){
...
<script>
	$('#disbursements-journal-summary-table_wrapper tbody').on('click', 'tr', function(){
		...
		summary_doc.find('input[name=amount_in_words]').val(toTitleCase(toWords(parseFloat(row_data.co_trans_doc_pay_amountpaid))));
		summary_doc.find('input[name=period]').val(row_data.co_trans_doc_part_period);
		summary_doc.find('input[name=prepared_by]').val(row_data.others_data[0].p_fname+' '+row_data.others_data[0].p_mname+' '+row_data.others_data[0].p_lname);
		summary_doc.find('input[name=verified_by]').val(row_data.others_data[0].co_trans_verifiedby);
		summary_doc.find('input[name=approved_by]').val(row_data.others_data[0].co_trans_approvedby);
		summary_doc.find('input[name=received_by]').val(row_data.others_data[0].co_trans_receivedby);
	...
	$('#disbursements-bp-table_wrapper tbody').on('click', 'tr', function(){
		var row_data = bp_summary_table.row(this).data();
		bp_transaction_details_table.ajax.url(window.location.origin+'/journals/disbursements/bp_transaction/get?bp_id='+row_data.co_bp_id).load();
		$(this).closest('table').find('tr').css('background-color', '#FFF');
		$(this).closest('table').find('tr').css('color', 'rgba(0,0,0,.87)');
		$(this).css('background-color', 'rgb(133, 150, 214)');
		$(this).css('color', '#FFF');
	...
	$('#disbursements-transaction-details-table_wrapper tbody').on('click', 'tr', function(){
		...
		bp_doc.find('input[name=amount_in_words]').val(toTitleCase(toWords(parseFloat(row_data.co_trans_doc_pay_amountpaid))));
		bp_doc.find('input[name=period]').val(row_data.co_trans_doc_part_period);
		bp_doc.find('input[name=prepared_by]').val(row_data.others_data[0].p_fname+' '+row_data.others_data[0].p_mname+' '+row_data.others_data[0].p_lname);
		bp_doc.find('input[name=verified_by]').val(row_data.others_data[0].co_trans_verifiedby);
		bp_doc.find('input[name=approved_by]').val(row_data.others_data[0].co_trans_approvedby);
		bp_doc.find('input[name=received_by]').val(row_data.others_data[0].co_trans_receivedby);
