...
class Users extends CI_Controller{
    ...
    public function get(){
        echo json_encode(array('data' => Co_Users_Model::company_superadmin_users_get($this->session->userdata('user')->main_company->cb_id)));
    }
    public function add(){
        var_dump($this->session->userdata('user')->main_company->cb_id);
        ...
        //     'u_name'=>$this->input->post('add-username'),
        //     'u_pass'=>password_hash($this->input->post('add-password'), PASSWORD_BCRYPT, ['cost' => 11]);
        //     'u_type'=>$this->input->post('add-type'),
        //     'u_company'=>'company',
        //     'subs_type'=>$this->session->userdata('user')->subs_type,
        //     'subs_exp_type'=>$this->session->userdata('user')->subs_exp_date,
        //     'setup'=>'0'
        // ];
