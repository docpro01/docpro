...
var lvl2 = $('#coa-lvl2').DataTable({
	...
	columnDefs: [{targets: 0, width: '70px'}, {targets: [1,2], width: '100px'}],
	order: [['2', 'asc']],
	scrollX: true,
	sDom: '<"top"f>rt<"bottom"p><"clear">',
	initComplete: function(){
...
var lvl3 = $('#coa-lvl3').DataTable({
	...
	columnDefs: [{targets: 0, width: '70px'},{targets: [1,2,3], width: '100px'}],
	scrollX: true,
	sDom: '<"top"f>rt<"bottom"p><"clear">',
	initComplete: function(){
...
var lvl4 = $('#coa-lvl4').DataTable({
	...
	columnDefs: [{targets: 0, width: '70px'},{targets: [1,2,3,4], width: '100px'}],
	scrollX: true,
	sDom: '<"top"f>rt<"bottom"p><"clear">',
	initComplete: function(){
...
var lvl5 = $('#coa-lvl5').DataTable({
	...
	order: [['1', 'asc']],
	columnDefs: [{targets: 0, width: '70px'}, {targets: [1,2,3,4,5], width: '100px'}],
	scrollX: true,
	sDom: '<"top"f>rt<"bottom"p><"clear">',
	initComplete: function(){
