...
// ACCOUNT ELEMENTS
	...
	public static function acc_elements_add($data){
		...
		$seq = count($last_record) > 0 ? (floatval($last_record[0]->lvl_1_code) + 1).'' : '1';
		$code = count($last_record) > 0 ? (floatval($last_record[0]->lvl_1_code) + 1).'' : '1';
		$record = ['lvl_1_seq' => $seq, 'lvl_1_code' => $code, 'lvl_1_name' => $data['lvl_1_name'], 'lvl_1_company' => $data['lvl_1_company'], 'lvl_1_setup_company' => $data['lvl_1_setup_company']];
		self::$db->insert('coa_lvl_1', $record);
		$lvl_1_id = self::$db->insert_id();
		self::$db->insert('coa_lvl_2', ['lvl_2_seq' => '1', 'lvl_2_code' => '0', 'lvl_2_name' => $data['lvl_1_name'], 'lvl_2_company' => $data['lvl_1_company'], 'lvl_2_setup_company' => $data['lvl_1_setup_company']]);
		$lvl_2_id = self::$db->insert_id();
		self::$db->insert('coa_lvl_3', ['lvl_3_seq' => '1', 'lvl_3_code' => '00', 'lvl_3_code_int' => '0', 'lvl_3_name' => $data['lvl_1_name'], 'lvl_3_company' => $data['lvl_1_company'], 'lvl_3_setup_company' => $data['lvl_1_setup_company']]);
		$lvl_3_id = self::$db->insert_id();
		self::$db->insert('coa_lvl_4', ['lvl_4_seq' => '1', 'lvl_4_code' => '0', 'lvl_4_name' => $data['lvl_1_name'], 'lvl_4_company' => $data['lvl_1_company'], 'lvl_4_setup_company' => $data['lvl_1_setup_company']]);
		$lvl_4_id = self::$db->insert_id();
		self::$db->insert('coa_lvl_5', ['lvl_5_seq' => '1', 'lvl_5_code' => '0', 'lvl_5_name' => $data['lvl_1_name'], 'lvl_5_company' => $data['lvl_1_company'], 'lvl_5_setup_company' => $data['lvl_1_setup_company']]);
...
// ACCOUNT CLASSIFICATION
	...
	public static function acc_classification_add($data){
		...
		$record = ['lvl_2_seq' => $seq, 'lvl_2_code' => $code, 'lvl_2_name' => $data['lvl_2_name'], 'lvl_2_company' => $data['lvl_2_company'], 'lvl_2_setup_company' => $data['lvl_2_setup_company']];
...
// LINE ITEMS
	...
	public static function line_items_add($data){
		...
		$code_int = count($last_record) > 0 ? (floatval($last_record[0]->lvl_3_code_int) + 1).'' : '1';
		$code = strlen($code_int) === 1 ? '0'.$code_int : $code_int;
		$record = ['lvl_3_seq' => $seq, 'lvl_3_code' => $code, 'lvl_3_code_int' => $code_int, 'lvl_3_name' => $data['lvl_3_name'], 'lvl_3_company' => $data['lvl_3_company'], 'lvl_3_setup_company' => $data['lvl_3_setup_company'], 'lvl_3_bir' => $data['lvl_3_bir']];
		self::$db->insert('coa_lvl_3', $record);
		$lvl_3_id = self::$db->insert_id();
		self::$db->insert('coa_lvl_4', ['lvl_4_seq' => '1', 'lvl_4_code' => '0', 'lvl_4_name' => $data['lvl_3_name'], 'lvl_4_company' => $data['lvl_3_company'], 'lvl_4_setup_company' => $data['lvl_3_setup_company']]);
		$lvl_4_id = self::$db->insert_id();
	...
	public static function line_items_edit($data){
		...
		self::$db->where('lvl_3_id', $data['line-items-edit-id'])->update('coa_lvl_3', ['lvl_3_code' => $data['lvl_3_code'], 'lvl_3_code_int' => floatval($data['lvl_3_code']), 'lvl_3_name' => $data['lvl_3_name'], 'lvl_3_bir' => $data['lvl_3_bir']]);
...
// ACCOUNT SUBCLASSIFICATION
	...
	public static function acc_sub_add($data){
		...
		$record = ['lvl_4_seq' => $seq, 'lvl_4_code' => $code, 'lvl_4_name' => $data['lvl_4_name'], 'lvl_4_company' => $data['lvl_4_company'], 'lvl_4_setup_company' => $data['lvl_4_setup_company']];
