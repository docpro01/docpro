...
class Transactions_Model extends CI_Model{
	...
	public static function get_bp($user){
		return self::$db->from('co_business_partners cbp')->join('business_partners_type bpt', 'bpt.bpt_id = cbp.bpt_id')->where(['cbp.cb_id' => $user->cb_id])->get()->result();
	}
