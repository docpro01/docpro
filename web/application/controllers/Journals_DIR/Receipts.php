...
class Receipts extends MY_Controller{
	...
	public function transaction_vat(){
		echo json_encode(Receipts_Model::get_vat($this->session->userdata('user')));
	}
	...
	public function transaction_ewt(){
		echo json_encode(Receipts_Model::get_ewt($this->session->userdata('user')));
	}

	public function transaction_fwt(){
		echo json_encode(Receipts_Model::get_fwt($this->session->userdata('user')));
	}
	...
	public function save_receipt_trans(){
		...
		return redirect('journals/receipts');
	}
