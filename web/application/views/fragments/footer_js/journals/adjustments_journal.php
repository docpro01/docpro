...
<script>
	var summary_table = $('#adjustments-journal-summary-table').DataTable({
							ajax: window.location.origin+'/journals/adjustments/journals_summary/get',
							columns: [
										{'data': 'co_trans_id'},
										{
	...
	var bp_summary_table = $('#adjustments-bp-table').DataTable({
								ajax: window.location.origin+'/journals/adjustments/bp/get',
								columns: [
											{'data': 'co_bp_class'},
											{'data': 'co_bp_code'},
											{'data': 'bp_name'},
	...
	var bp_transaction_details_table = $('#adjustments-transaction-details-table').DataTable({
							ajax: window.location.origin+'/journals/adjustments/bp_transaction/get?bp_id=0',
							columns: [
										{'data': 'co_trans_id'},
										{
											mData: function(rowData, settings, fullData){
...
<script>
	$('#adjustments-journal-summary-table_wrapper tbody').on('click', 'tr', function(){
	...
	$('#adjustments-bp-table_wrapper tbody').on('click', 'tr', function(){
		var row_data = bp_summary_table.row(this).data();
		bp_transaction_details_table.ajax.url(window.location.origin+'/journals/adjustments/bp_transaction/get?bp_id='+row_data.co_bp_id).load();
		$(this).closest('table').find('tr').css('background-color', '#FFF');
		$(this).closest('table').find('tr').css('color', 'rgba(0,0,0,.87)');
		$(this).css('background-color', 'rgb(133, 150, 214)');
		$(this).css('color', '#FFF');
	...
	$('#adjustments-transaction-details-table_wrapper tbody').on('click', 'tr', function(){
