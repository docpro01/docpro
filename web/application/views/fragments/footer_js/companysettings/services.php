<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/company_settings/services_seq.js"></script>
<script>
    $(document).ready(function(){
        var seq = 0;
        var table_summary = $('#services-summary-table').DataTable({
            ajax: window.location.origin+'/company_settings/services/get',
            columns:[
                        {
                        ...
                        {'data': 'co_s_code'}, {'data': 'co_s_name'}, {'data': 'co_s_shortname'}, {'data': 'co_s_description'}, {'data': 'co_pcc_name'}, {'data': 'co_de_name'}
            ],
        ...
        $('#services-table').on('click', '.view', function(){
            ...
            $(this).popover({
                ...
                callback: function(){
                    $('#view-seq').val(seq);
                    $('#view-code').val(data.co_s_code);
                    $('#view-name').val(data.co_s_name);
                    $('#view-shortname').val(data.co_s_shortname);
                    $('#view-description').val(data.co_s_description);
        ...
        $('#services-table').on('click', '.edit', function(){
            ...
            $(this).popover({
                ...
                callback: function(){
                    $('#edit-seq').val(seq);
                    $('#edit-name').val(data.co_s_name);
                    $('#edit-shortname').val(data.co_s_shortname);
                    $('#edit-description').val(data.co_s_description);
                    $('#edit-profit-cost-center').val(data.co_pcc_name);
                    $('#edit-department').val(data.co_de_name);
                    $('#edit-id').val(data.co_s_id);
        ...
        $('#services-table').on('click', '.update', function(){
            ...
            $(this).popover({
                ...
                callback: function(){
                    $('#update-seq').val(seq);
                    $('#update-name').val(data.co_s_name);
                    $('#update-shortname').val(data.co_s_shortname);
                    $('#update-description').val(data.co_s_description);
        ...
        $('.navbar-body').on('click', '.add-profit-cost-center-btn', function(){
            $('#add-options').html($('#s-profit-cost-center-select').html());
            initRipple();
        });
        $('.navbar-body').on('click', '.add-department-btn', function(){
            $('#add-options').html($('#s-department-select').html());
            initRipple();
        });
        $('.navbar-body').on('click', '.edit-profit-cost-center-btn', function(){
            $('#edit-options').html($('#s-profit-cost-center-select').html());
            initRipple();
        });
        $('.navbar-body').on('click', '.edit-department-btn', function(){
            $('#edit-options').html($('#s-department-select').html());
            initRipple();
        });
        $('.navbar-body').on('click', '.update-profit-cost-center-btn', function(){
            $('#update-options').html($('#s-profit-cost-center-select').html());
            initRipple();
        });
        $('.navbar-body').on('click', '.update-department-btn', function(){
            $('#update-options').html($('#s-department-select').html());
            initRipple();
        });
