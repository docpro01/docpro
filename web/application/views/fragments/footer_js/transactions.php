...
<script>
	var summary_table = $('#transactions-journal-summary-table').DataTable({
							ajax: window.location.origin+'/transactions/journals_summary/get',
							scrollX: true,
							columns: [
										{'data': 'co_trans_id'},
										{
	...
	var bp_summary_table = $('#transactions-bp-table').DataTable({
								ajax: window.location.origin+'/transactions/bp/get',
								columns: [
											{'data': 'co_bp_class'},
											{'data': 'co_bp_code'},
											{'data': 'bp_name'},
	...
	var bp_transaction_details_table = $('#transactions-transaction-details-table').DataTable({
							ajax: window.location.origin+'/transactions/bp_transaction/get?bp_id=0',
							columns: [
										{'data': 'co_trans_id'},
										{
											mData: function(rowData, settings, fullData){
...
<script>
	$('#transactions-journal-summary-table_wrapper tbody').on('click', 'tr', function(){
		...
		$('#summary-document .document_temp').removeClass('hide');
		$('#summary-document .document_1').removeClass('hide');
		$('#summary-document .document_2').removeClass('hide');
		$('#summary-document .document_3').removeClass('hide');
		if(row_data.co_journ_trans_id === '5'){
			$('#summary-document .document_temp').addClass('hide');
			$('#summary-document .document_1').addClass('hide');
			$('#summary-document .document_3').addClass('hide');
		}else if(row_data.co_journ_trans_id === '7'){
			$('#summary-document .document_temp').addClass('hide');
			$('#summary-document .document_1').addClass('hide');
			$('#summary-document .document_2').addClass('hide');
		}else{
			$('#summary-document .document_temp').addClass('hide');
			$('#summary-document .document_2').addClass('hide');
			$('#summary-document .document_3').addClass('hide');
	...
	$('#transactions-bp-table_wrapper tbody').on('click', 'tr', function(){
		...
		bp_transaction_details_table.ajax.url(window.location.origin+'/transactions/bp_transaction/get?bp_id='+row_data.co_bp_id).load();
		$(this).closest('table').find('tr').css('background-color', '#FFF');
		$(this).closest('table').find('tr').css('color', 'rgba(0,0,0,.87)');
		$(this).css('background-color', 'rgb(133, 150, 214)');
		$(this).css('color', '#FFF');
