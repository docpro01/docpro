<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/docpro_settings/tax_setup_seq.js"></script>
    ...
    $(document).ready(function(){
        var tt_table = $('#tax-types-table').DataTable({
            ...
            columns:[
                    ...
                    columnDefs: [{targets: 0, width: '100px'}, {targets: 1, width: '80px'}, {targets: 3, width: '120px'}],
                    order: [['1', 'asc']],
                    scrollX: true,
                    initComplete: function(json, src){
                        initRipple();
