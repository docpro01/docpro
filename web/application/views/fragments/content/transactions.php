									...
									<div role="tabpanel" class="tab-pane active" id="summary">
										<div class='card'>
											<div class='card-body' style='padding-top: 10px;'>
												<table id='transactions-journal-summary-table' class='table table-hover table-bordered' cellspacing="0" style='min-width: 1450px;'>
													<thead>
														<th>Trans ID</th>
														<th>Trans Date</th>
														<th>Journal</th>
										...
										<div id='summary-document-details-card' class='card box box-primary' style='margin-top: 20px;'>
										...
										<div id='summary-journal-entries-card' class='card box box-primary collapsed-box' style='margin-top: 20px;'>
											<div class='card-header'>
												<div class='card-title'>
										...
										<div id='summary-document' class='card box box-primary collapsed-box' style='margin-top: 20px;'>
											<div class='card-header'>
												<div class='card-title'>
