			...
			<div class='row' style="margin-right: 0; margin-left: 0; padding-right: 20px; padding-left: 20px;">
				<div id='journals-seq'>
					<ul class='seq-canvas'>
						<li>
							<div class='col-md-12'>
								<table id='journals-summary-table' class='table table-bordered' style="min-width: 100%">
									<thead>
										<th>Code</th>
										<th>Name</th>
										<th>Shortname</th>
		...
		<div class='card-body hide-table-setting' style='padding: 0;'>
			<div class='row'>
				<div class='col-md-12' style="margin-top: 25px;">
					<div class='col-md-12' id='journals-table-row' style="padding: 0;">
						<button id='add' type='button' class='btn btn-info btn-sm btn-raised ripple-effect'><i class='fa fa-plus'></i></button>
						<table id='journals-table' class='table table-hovered table-bordered' style="min-width: 100%;">
							<thead>
								<th>Options</th>
...
<div id='update-popover' class='modal fade' role='dialog' tabindex='-1'>
	...
	<div>
		<form action='<?php echo base_url(); ?>company_settings/journals/update' method='post' class='body'>
			...
			<input type="hidden" id='co-j-id' name="co-j-id">
