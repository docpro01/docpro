		...
		<div class='card-body' style='padding: 0;'>
			...
			<div class='row' style="margin-right: 0; margin-left: 0; padding-right: 20px; padding-left: 20px;">
				<div id='services-seq'>
					<ul class='seq-canvas'>
						<li>
							<table id='services-summary-table' class='table table-bordered' style="min-width: 100%;">
								<thead>
									<th>Sequence</th>
									<th>Code</th>
									<th>Name</th>
						...
						<li>
							...
							<div class='col-md-12' id='transactions-table-row'>
								<table id='services-table' class='table table-hovered table-bordered' style="min-width: 100%;">
									<thead>
										<th>Options</th>
										<th>Sequence</th>
										<th>Code</th>
		...
		<div class='card-body hide-table-setting' style='padding: 0;'>
			<div class='row'>
				<div class='col-md-12' style="margin-top: 25px;">
					<div class='col-md-12' id='transactions-table-row' style="padding: 0;">
						<button id='add' type='button' class='btn btn-info btn-sm btn-raised ripple-effect'><i class='fa fa-plus'></i></button>
						<table id='services-table' class='table table-hovered table-bordered' style="min-width: 100%;">
							<thead>
								<th>Options</th>
...
<div id='s-profit-cost-center-select' style='display: none;'>
...
<div id='s-department-select' style='display: none;'>
