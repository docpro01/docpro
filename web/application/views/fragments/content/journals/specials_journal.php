							...
							<div role="tabpanel">
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane active" id="summary">
										<div class='card'>
											<div class='card-body' style='padding-top: 10px;'>
												<table id='specials-journal-summary-table' class='table table-hover table-bordered' cellspacing="0" style='min-width: 1400px;'>
													<thead>
														<th>Trans ID</th>
														<th>Trans Date</th>
														<th>Journal</th>
									...
									<div role="tabpanel" class="tab-pane" id="business-partners">
										<div class='card'>
											<div class='card-body' style='padding-top: 10px;'>
												<table id='specials-bp-table' class='table table-hover table-bordered table-striped table-responsive' cellspacing="0" style="min-width: 1200px">
													<thead>
														<th>BP Class</th>
														<th>BP Code</th>
														<th>BP Name</th>
										...
										<div id='bp-transaction-details' class='card box box-primary collapsed-box' style='margin: 0;'>
											...
											<div class='card-body box-body' style="padding-top: 10px;">
												<table id='specials-transaction-details-table' class='table table-bordered table-hovered table-striped' style='min-width: 1400px;'>
													<thead>
														<th>Trans ID</th>
														<th>Trans Date</th>
														<th>Journal</th>
