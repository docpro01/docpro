		...
		<div class='card-body' style='padding-top: 10px;'>
			<div class='row'>
				<div class='col-md-12' id='banks-table-row'>
					<button type='button' id='add' class='btn btn-info btn-sm btn-raised ripple-effect'><i class='fa fa-plus'></i></button>
...
<div id='add-popover' class='modal fade' role='dialog' tabindex='-1'>
	...
	<div>
		<form action='<?php echo base_url(); ?>docpro_setup/journals/add' method='post' class='body'>
...
<div id='edit-popover' class='modal fade' role='dialog' tabindex='-1'>
	...
	<div>
		<form action='<?php echo base_url(); ?>docpro_setup/journals/edit' method='post' class='body'>
			<div class='modal-body'>
				<table width='90%'>
					<tr>
						<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Name</label></td>
...
<div id='update-popover' class='modal fade' role='dialog' tabindex='-1'>
	...
	<div>
		<form action='<?php echo base_url(); ?>docpro_setup/journals/update' method='post' class='body'>
			<div class='modal-body'>
				<table width='90%'>
					<tr>
						<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Name</label></td>
