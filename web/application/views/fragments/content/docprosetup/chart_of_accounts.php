						...
						<div id='coa-seq'>
							<ul class='seq-canvas'>
								<li class="<?php if($seq_active === '1') echo $seq_active; ?>">
									<button id='add-acc-elements' class='btn btn-info btn-sm btn-raised ripple-effect title' custom-title='Add'><i class='fa fa-plus'></i></button>
		...
		<div class='modal-body'>
			<table width='90%'>
				<tr>
					...
					<td colspan='3' style='padding-top: 10px;'><input id='acc-elements-add-name' name='acc-elements-add-name' class='form-control no-space' type='text' required>
					</td>
				</tr>
			</table>
		</div>
	...
	<div class='modal-body'>
		<table width='90%'>
			...
			<tr>
				...
				<td colspan='3' style='padding-top: 5px;'><input id='acc-elements-view-name' class='form-control' type='text' readonly>
				</td>
			</tr>
		</table>
	</div>
	...
	<form action="<?php echo base_url(); ?>docpro_setup/chart_of_accounts/acc_elements_edit" method='post'>
		<div class='modal-body'>
			<table width='90%'>
				<tr>
					<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Code</label></td>
					<td colspan='3' style='padding-top: 10px;'><input id='acc-elements-edit-code' name='acc-elements-edit-code' class='form-control number no-space' type='text' required></td>
				</tr>
					<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Element</label></td>
					<td colspan='3' style='padding-top: 5px;'><input id='acc-elements-edit-name' name='acc-elements-edit-name' class='form-control no-space' type='text' required>
					</td>
				</tr>
			</table>
		</div>
	...
	<form action="<?php echo base_url(); ?>docpro_setup/chart_of_accounts/acc_elements_delete" method='post'>
		<div class='modal-body'>
			<table width='90%'>
				...
				<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Element</label></td>
					<td colspan='3' style='padding-top: 5px;'><input id='acc-elements-delete-name' name='acc-elements-delete-name' class='form-control' type='text' readonly>
					</td>
				</tr>
			</table>
		</div>
			...
			<table width='90%'>
				<tr>
					...
					<td style='padding-top: 10px;'>
						<input id='acc-classification-add-elements-value' type="hidden" name="acc-classification-add-elements">
					...
					<td style="padding-top: 7px; width: 80px;">
						<input type="text" id="add-lvl2-lvl1-code" name="add-lvl2-lvl1-code" class='form-control no-space' placeholder="code" readonly style="width: 80px; text-align: center; height: 34px;" required>
					</td>
				</tr>
				<tr>
					<td style='width: 150px; text-align: right; padding-right: 20px;'><label>Classification</label></td>
					<td colspan='2'><input id='acc-classification-add-name' name='acc-classification-add-name' class='form-control no-space' type='text' required>
					</td>
				</tr>
			</table>
		</div>
	...
	<div class='modal-body'>
		<table width='90%'>
			<tr>
				...
				<td style="padding-top: 7px; width: 80px;">
					<input type="text" id="view-lvl2-lvl1-code" class='form-control' placeholder="code" readonly style="width: 80px; text-align: center; height: 34px;">
				</td>
			</tr>
			<tr>
				<td style='width: 150px; text-align: right; padding-right: 20px;'><label>Code</label></td>
				<td colspan='2'><input id='acc-classification-view-code' class='form-control' type='text' readonly></td>
			</tr>
			<tr>
				<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Classification</label></td>
				<td colspan='2' style='padding-top: 5px;'><input id='acc-classification-view-name' class='form-control' type='text' readonly>
				</td>
			</tr>
		</table>
	</div>
		...
		<div class='modal-body'>
			<table width='90%'>
				<tr>
					<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Element</label></td>
					<td style='padding-top: 10px;'>
						<input type="hidden" id='acc-classification-edit-elements-value' name="acc-classification-edit-elements">
					...
					<td style="padding-top: 7px; width: 80px;">
						<input type="text" id="edit-lvl2-lvl1-code" class='form-control no-space' placeholder="code" readonly style="width: 80px; text-align: center; height: 34px;" required>
					</td>
				</tr>
				<tr>
					<td style='width: 150px; text-align: right; padding-right: 20px;'><label>Code</label></td>
					<td colspan='2'><input id='acc-classification-edit-code' name='acc-classification-edit-code' class='form-control number no-space' type='text' required></td>
				</tr>
				<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Classification</label></td>
					<td colspan='2' style='padding-top: 5px;'><input id='acc-classification-edit-name' name='acc-classification-edit-name' class='form-control no-space' type='text' required>
					</td>
				</tr>
			</table>
		</div>
		...
		<div class='modal-body'>
			<table width='90%'>
				<tr>
					...
					<td style="padding-top: 7px; width: 80px;">
						<input type="text" id="delete-lvl2-lvl1-code" class='form-control no-space' placeholder="code" readonly style="width: 80px; text-align: center; height: 34px;" required>
					</td>
				</tr>
				<tr>
					<td style='width: 150px; text-align: right; padding-right: 20px;'><label>Code</label></td>
					<td colspan='2'><input type='text' id='acc-classification-delete-code' name='acc-classification-delete-code' class='form-control' readonly></td>
				</tr>
				<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Classification</label></td>
					<td colspan='2' style='padding-top: 5px;'><input id='acc-classification-delete-name' name='acc-classification-delete-name' class='form-control' type='text' readonly>
					</td>
				</tr>
			</table>
		</div>
		...
		<div class='modal-body'>
			<table width='90%'>
				<tr>
					<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Classification</label></td>
					<td style='padding-top: 10px;'>
						<input type="hidden" id='line-items-add-classfication-value' name="line-items-add-classification">
						<select id="line-items-add-classfication" name='line-items-add-classification-select' class="demo-default" placeholder="Select..." style="z-index: 9999999999;" required disabled>
							<option value="">Select...</option>
					...
					<td style="padding-top: 7px; width: 80px;">
						<input type="text" id="add-lvl3-lvl2-code" name="add-lvl3-lvl2-code" class='form-control no-space' placeholder="code" readonly style="width: 80px; text-align: center; height: 34.5px;" required>
					</td>
				</tr>
				<tr>
					<td style='width: 150px; text-align: right; padding-right: 20px;'><label>Line Item</label></td>
					<td colspan='2'><input id='line-items-add-name' name='line-items-add-name' class='form-control no-space' type='text' required>
					</td>
				</tr>
				<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>BIR</label></td>
					<td colspan='2' style='padding-top: 5px;'><input id='line-items-add-bir' name='line-items-add-bir' class='form-control no-space' type='text' required>
					</td>
				</tr>
			</table>
		</div>
	...
	<div class='modal-body'>
		<table width='90%'>
			<tr>
				...
				<td style="padding-top: 7px; width: 80px;">
					<input type="text" id="view-lvl3-lvl2-code" class='form-control' placeholder="code" readonly style="width: 80px; text-align: center; height: 34.5px;">
				</td>
			</tr>
			<tr>
				<td style='width: 150px; text-align: right; padding-right: 20px;'><label>Code</label></td>
				<td colspan='2'><input id='line-items-view-code' class='form-control' type='text' readonly></td>
			</tr>
			<tr>
				<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Line Item</label></td>
				<td colspan='2' style='padding-top: 5px;'><input id='line-items-view-name' class='form-control' type='text' readonly>
				</td>
			</tr>
			<tr>
				<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>BIR</label></td>
				<td colspan='2' style='padding-top: 5px;'><input id='line-items-view-bir' class='form-control' type='text' readonly>
				</td>
			</tr>
		</table>
	</div>
		...
		<div class='modal-body'>
			<table width='90%'>
				<tr>
					<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Classification</label></td>
					<td style='padding-top: 10px;'>
						<input id='line-items-edit-classfication-value' type="hidden" name="line-items-edit-classification">
						<select id="line-items-edit-classfication" name='line-items-edit-classification-select' class="demo-default" placeholder="Select..." style="z-index: 9999999999;" required disabled>
							<option value="">Select...</option>
							<?php foreach ($acc_classification as $key => $value) { ?>
								<option code='<?php echo $value->lvl_2_code; ?>' value="<?php echo $value->lvl_2_id; ?>"><?php echo $value->lvl_2_name; ?></option>
							<?php } ?>
					...
					<td style="padding-top: 7px; width: 80px;">
						<input type="text" id="edit-lvl3-lvl2-code" name="edit-lvl3-lvl2-code" class='form-control no-space' placeholder="code" readonly style="width: 80px; text-align: center; height: 34.5px;" required>
					</td>
				</tr>
				<tr>
					<td style='width: 150px; text-align: right; padding-right: 20px;'><label>Code</label></td>
					<td colspan='2'><input id='line-items-edit-code' name='line-items-edit-code' class='form-control number no-space' type='text' required></td>
				</tr>
				<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Line Item</label></td>
					<td colspan='2' style='padding-top: 5px;'><input id='line-items-edit-name' name='line-items-edit-name' class='form-control no-space' type='text' required>
					</td>
				</tr>
				<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>BIR</label></td>
					<td colspan='2' style='padding-top: 5px;'><input id='line-items-edit-bir' name='line-items-edit-bir' class='form-control no-space' type='text' required>
					</td>
				</tr>
			</table>
		</div>
		...
		<div class='modal-body'>
			<table width='90%'>
				<tr>
					...
					<td style="padding-top: 7px; width: 80px;">
						<input type="text" id="delete-lvl3-lvl2-code" name="edit-lvl3-lvl2-code" class='form-control no-space' placeholder="code" readonly style="width: 80px; text-align: center; height: 34.5px;" required>
					</td>
				</tr>
				<tr>
					<td style='width: 150px; text-align: right; padding-right: 20px;'><label>Code</label></td>
					<td colspan='2'><input id='line-items-delete-code' name='line-items-delete-code' class='form-control' type='text' readonly></td>
				</tr>
				<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Line Item</label></td>
					<td colspan='2' style='padding-top: 5px;'><input id='line-items-delete-name' name='line-items-delete-name' class='form-control' type='text' readonly>
					</td>
				</tr>
				<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>BIR</label></td>
					<td colspan='2' style='padding-top: 5px;'><input id='line-items-delete-bir' name='line-items-delete-bir' class='form-control no-space' type='text' required disabled>
					</td>
				</tr>
			</table>
		</div>
		...
		<div class='modal-body'>
			<table width='90%'>
				<tr>
					<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Line Item</label></td>
					<td style='padding-top: 10px;'>
						<input id='acc-sub-add-line-item-value' type="hidden" name="acc-sub-add-line-item">
					...
					<td style="padding-top: 7px; width: 80px;">
						<input type="text" id="add-lvl4-lvl3-code" name="add-lvl4-lvl3-code" class='form-control no-space' placeholder="code" readonly style="width: 80px; text-align: center; height: 34px;" required>
					</td>
				</tr>
				<tr>
					<td style='width: 150px; text-align: right; padding-right: 20px;'><label>Subclassification</label></td>
					<td colspan='2'><input id='acc-sub-add-name' name='acc-sub-add-name' class='form-control no-space' type='text' required>
					</td>
				</tr>
			</table>
		</div>
	...
	<div class='modal-body'>
		<table width='90%'>
			<tr>
				...
				<td style="padding-top: 7px; width: 80px;">
					<input type="text" id="view-lvl4-lvl3-code" class='form-control' placeholder="code" readonly style="width: 80px; text-align: center; height: 34px;">
				</td>
			</tr>
			<tr>
				<td style='width: 150px; text-align: right; padding-right: 20px;'><label>Code</label></td>
				<td colspan='2'><input id='acc-sub-view-code' class='form-control' type='text' readonly></td>
			</tr>
			<tr>
				<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Subclassification</label></td>
				<td colspan='2' style='padding-top: 5px;'><input id='acc-sub-view-name' class='form-control' type='text' readonly>
				</td>
			</tr>
		</table>
	</div>
		...
		<div class='modal-body'>
			<table width='90%'>
				<tr>
					<td style='padding-top: 10px; width: 150px; text-align: right; padding-right: 20px;'><label>Line Item</label></td>
					<td style='padding-top: 10px;'>
						<input id='acc-sub-edit-line-item-value' type="hidden" name="acc-sub-edit-line-item">
					...
					<td style="padding-top: 7px; width: 80px;">
						<input type="text" id="edit-lvl4-lvl3-code" name="edit-lvl4-lvl3-code" class='form-control no-space' placeholder="code" readonly style="width: 80px; text-align: center; height: 34px;" required>
					</td>
				</tr>
				<tr>
					<td style='width: 150px; text-align: right; padding-right: 20px;'><label>Code</label></td>
					<td colspan='2'><input id='acc-sub-edit-code' name='acc-sub-edit-code' class='form-control number no-space' type='text' required></td>
				</tr>
				<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Subclassification</label></td>
					<td colspan='2' style='padding-top: 5px;'><input id='acc-sub-edit-name' name='acc-sub-edit-name' class='form-control no-space' type='text' required>
					</td>
				</tr>
			</table>
		</div>
		...
		<div class='modal-body'>
			<table width='90%'>
				<tr>
					...
					<td style="padding-top: 7px; width: 80px;">
						<input type="text" id="delete-lvl4-lvl3-code" name="delete-lvl4-lvl3-code" class='form-control no-space' placeholder="code" readonly style="width: 80px; text-align: center; height: 34px;" required>
					</td>
				</tr>
				<tr>
					<td style='width: 150px; text-align: right; padding-right: 20px;'><label>Code</label></td>
					<td colspan='2'><input id='acc-sub-delete-code' name='acc-sub-delete-code' class='form-control' type='text' readonly></td>
				</tr>
				<tr>
					<td style='padding-top: 5px; width: 150px; text-align: right; padding-right: 20px;'><label>Subclassification</label></td>
					<td colspan='2' style='padding-top: 5px;'><input id='acc-sub-delete-name' name='acc-sub-delete-name' class='form-control' type='text' readonly>
					</td>
				</tr>
			</table>
		</div>
