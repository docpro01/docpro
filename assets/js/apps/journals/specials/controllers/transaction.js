angular.module('journals')
		...
		//Document
			...
			$scope.journal_transaction_id = 8;
		...
		//Business Partner
			...
			$http.get(window.location.origin+'/journals/specials/transaction/bp/get').then(function success(response){
		...
		//MODE OF PAYMENT
			...
			$http.get(window.location.origin+'/journals/specials/transaction/mop/get').then(function success(response){
				$.each(response.data, function(index, data){
