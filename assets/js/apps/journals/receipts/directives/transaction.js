		...
		.directive('addProductServicesBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window.location.origin+'/journals/receipts/transaction/product_service/get').then(function success(response){
		...
		.directive('addVatBtnFunction', function($compile){
			return{
				...
				controller: function($scope,$http){
					...
					$http.get(window.location.origin+'/journals/receipts/transaction/vat/get').then(function success(response){
						$.each(response.data, function(index, data){
		...
		.directive('addDiscountsBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window.location.origin+'/journals/receipts/transaction/discount/get').then(function success(response){
						$.each(response.data, function(index, data){
		...
		.directive('addExpandedTaxBtnFunction', ['$compile', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window.location.origin+'/journals/receipts/transaction/ewt/get').then(function success(response){
						$.each(response.data, function(index, data){
		...
		.directive('addFinalWithholdingTaxBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window.location.origin+'/journals/receipts/transaction/fwt/get').then(function success(response){
						$.each(response.data, function(index, data){
		...
		.directive('addDocumentReferenceBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window.location.origin+'/journals/receipts/transaction/doc_ref/get').then(function success(response){
						$.each(response.data, function(index, data){
		...
		.directive('addBankDetailsBtnFunction', function($compile){
			return{
				...
				controller: function($scope, $http){
					...
					$http.get(window.location.origin+'/journals/receipts/transaction/bank/get').then(function success(response){
						$.each(response.data, function(index, data){
