angular.module('transactions')
		...
		//Business Partner
			...
			$http.get(window.location.origin+'/journals/sales/transaction/bp/get').then(function success(response){
		...
		//MODE OF PAYMENT
			...
			$http.get(window.location.origin+'/journals/sales/transaction/mop/get').then(function success(response){
				$.each(response.data, function(index, data){
